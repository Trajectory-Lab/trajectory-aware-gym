...
class CompositeFitness:
    ...
    Set weight to 0.0 in FitnessConfig to disable any term for ablation.
    """
    ...
    def _build_default_terms(self) -> list[tuple[float, FitnessTerm]]:
        return [
            ...
            (self._config.fitness_loop_penalty_weight, LoopDetectionPenaltyTerm(self._config)),
            (self._config.fitness_step_efficiency_weight, StepEfficiencyBonusTerm(self._config)),
        ]
    ...
    def evaluate(self, trajectory: TrajectoryLog) -> FitnessResult:
        ...
        return FitnessResult(
            ...
            metadata={
                ...
                "lambda": self._config.fitness_lambda,
            },
        )
